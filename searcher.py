...
def start(keyword):
    ...
    for i in range(tab_counts):     #opening top 10 links
        ...
        with open("C:\\Users\\kritesh\\Desktop\\Project\\paragraph\\"+name, 'w') as filehandle:
...
def tagger(): 
    for i in range(1,11):
        #print("2")
        name="paragraph"+str(i)+".txt"
        file = open("C:\\Users\\kritesh\\Desktop\\Project\\paragraph\\"+name,'r')
        words=[]
        query_tagged = []
        while (True):
            #print("3")
        ...
        with open('C:\\Users\\kritesh\\Desktop\\Project\\paragraph tagged\\test_extended.txt', 'a') as filehandle:
            for i in words:
                filehandle.write('%s\n' % i)

        with open('C:\\Users\\kritesh\\Desktop\\Project\\paragraph tagged\\test_tagged.txt', 'a') as filehandle:
