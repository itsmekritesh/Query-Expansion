...
file=open("C:\\Users\\kritesh\\Desktop\\Project\\Bing\\paragraph tagged\\test_extended.txt","r")
word_dict={}
while (True):
    key=file.readline()
    if not key:
...
#print (word_dict)        
file1=open("C:\\Users\\kritesh\\Desktop\\Project\\Bing\\paragraph tagged\\word_dict.txt","w")
